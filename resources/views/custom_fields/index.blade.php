...
<div class="nav-tabs-custom"> 
  <ul class="nav nav-tabs"> 
    <li class="active"> <a href="#asset_custom_fields_tab" data-toggle="tab">{{ trans('admin/custom_fields/general.custom_fields') }}</a></li> 
    <li><a href="#consumables_category_custom_fields_tab" data-toggle="tab">{{ trans('admin/custom_fields/general.consumable_custom_fields') }}</a></li> 
  </ul>
  <div class="tab-content"> 
    <div class="tab-pane active" id="asset_custom_fields_tab">
      <div class="row">
        <div class="col-md-12">
          <div class="box box-default">
            ...
            <div class="box-header with-border">
              ...
              <div class="box-tools pull-right">
                ...
                <a href="{{ route('fieldsets.create', ['field_category' => 0]) }}" class="btn btn-sm btn-primary" data-tooltip="true" title="{{ trans('admin/custom_fields/general.create_fieldset_title') }}">{{ trans('admin/custom_fields/general.create_fieldset') }}</a>
                @endcan
              </div>
            </div><!-- /.box-header -->
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      @can('update', $fieldset)
                        ...
                        <a href="{{ route('fieldsets.show', ['fieldset' => $fieldset->id, 'field_category' => 0]) }}" data-tooltip="true" title="{{ trans('general.edit_fieldset') }}">
    ...
    <div class="tab-pane" id="consumables_category_custom_fields_tab">
    <div class="row">
        <div class="col-md-12">
          <div class="box box-default">
                    
            <div class="box-header with-border">
              <h2 class="box-title">{{ trans('admin/custom_fields/general.consumablefieldsets') }}</h2>
              <div class="box-tools pull-right">
                @can('create', \App\Models\CustomFieldset::class)
                <a href="{{ route('fieldsets.create', ['field_category' => 1]) }}" 
                   class="btn btn-sm btn-primary" 
                   data-tooltip="true" 
                   title="{{ trans('admin/custom_fields/general.create_consumable_fieldset_title') }}">{{ trans('admin/custom_fields/general.create_consumable_fieldset') }}</a> 
                @endcan
              </div>
              <div class="box-body">
              <table
                ...
                <thead>
                  <tr>
                    <th>{{ trans('general.name') }}</th>
                    <th>{{ trans('admin/custom_fields/general.qty_fields') }}</th>
                    <th>{{ trans('admin/custom_fields/general.used_by_categories') }}</th>
                    <th>{{ trans('table.actions') }}</th>
                  </tr>
                </thead>
                @if(isset($custom_fieldsets))
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      @can('update', $fieldset)
                        ...
                        <a href="{{ route('fieldsets.show', ['fieldset' => $fieldset->id, 'field_category' => 1]) }}" data-tooltip="true" title="{{ trans('general.edit_fieldset') }}">
                          <button type="submit" class="btn btn-info btn-sm">
                            <i class="fa-regular fa-rectangle-list"></i>
                          </button>
                        </a>

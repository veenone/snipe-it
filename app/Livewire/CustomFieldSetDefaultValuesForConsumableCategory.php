...
class CustomFieldSetDefaultValuesForConsumableCategory extends Component
{
    ...
    public function mount($model_id = null, $field_category = null)
    {
    ...
    public function fields()
    {
        ...
        if ($customFieldset) {         
            // dd($customFieldset->fields->where('field_category', $this->field_category));  
            return $customFieldset->fields->where('field_category', $this->field_category); // Filter fields by field_category
        }
